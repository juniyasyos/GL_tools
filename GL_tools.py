...
class ObjectManager:
    ...
    def create_polygon(self, vertices, color=colors['--White']):
        """
...
#         """
#         Initialize an object with its initial position, rotation, and scale.

#         Args:
#             position (tuple): The initial position in (x, y, z) format.
#             rotation (tuple): The initial rotation angles in (x, y, z) format.
#             scale (tuple): The initial scaling factors in (x, y, z) format.
#         """
...
#         Returns:
#             tuple: The current position in (x, y, z) format.
#         """
...
#         Args:
#             rotation (tuple): The new rotation angles in (x, y, z) format.
#         """
#         self.rotation = rotation
...
#         Returns:
#             tuple: The current rotation angles in (x, y, z) format.
#         """
...
#         Args:
#             scale (tuple): The new scaling factors in (x, y, z) format.
#         """
#         self.scale = scale
...
#         Returns:
#             tuple: The current scaling factors in (x, y, z) format.
#         """
#         return self.scale
...
#         Args:
#             translation_vector (tuple): The translation vector in (x, y, z) format.
#         """
#         self.position = tuple(p + t for p, t in zip(self.position, translation_vector))

#     def rotate(self, rotation_vector):
#         """
#         Rotate the object by a given rotation vector.

#         Args:
#             rotation_vector (tuple): The rotation vector in (x, y, z) format.
#         """
#         self.rotation = tuple(r + a for r, a in zip(self.rotation, rotation_vector))

#     def scale_uniformly(self, scale_factor):
#         """
#         Scale the object uniformly by a given scale factor.

#         Args:
#             scale_factor (float): The uniform scale factor to apply.
#         """
#         self.scale = tuple(s * scale_factor for s in self.scale)

#     def apply_global_translation(self, global_translation):
#         """
#         Apply global translation to the object.

#         Args:
#             global_translation (tuple): The global translation in (x, y, z) format.
#         """
#         self.translate(global_translation)

#     def apply_global_rotation(self, global_rotation):
#         """
#         Apply global rotation to the object.

#         Args:
#             global_rotation (tuple): The global rotation angles in (x, y, z) format.
#         """
#         self.rotate(global_rotation)
